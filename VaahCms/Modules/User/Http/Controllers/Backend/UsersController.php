...
use VaahCms\Modules\User\Models\User;
...
class UsersController extends Controller
{
    ...
    public function getAssets(Request $request)
    {
        ...
        try{
            ...
            $data['fillable']['columns'] = User::getFillableColumns();
            $data['fillable']['except'] = User::getUnFillableColumns();
            $data['empty_item'] = User::getEmptyItem();
