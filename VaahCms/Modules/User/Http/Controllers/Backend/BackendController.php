...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-user';
        ...
        */
        ...
        return view('user::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            ...
            'version' => config('settings.global.user_version')??config('user.version'),
            'is_dev' => config('user.is_dev'),
        ];
