<?php  namespace VaahCms\Themes\ProductTheme\Notifications;
...
class ActivationLinkNotification extends Notification {
     ...
     * @return void
     */
    public function __construct(ProductThemeRegistration $registration)
    {
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->action(
                'Activate',
                route(
                    'vh.frontend.producttheme.signup.activate',
