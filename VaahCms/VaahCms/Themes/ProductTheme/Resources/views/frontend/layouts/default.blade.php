...
<html lang="en">
    <head>
        ...
        <script src="{{vh_theme_assets_url("ProductTheme", "build/script.js")}}"></script>


    <!--
        @if(env('THEME_PRODUCTTHEME_ENV') == 'develop')
            <link href="http://localhost:8080/producttheme/assets/css/build.css"
                  rel="stylesheet" media="screen">
            <link href="http://localhost:8080/producttheme/assets/css/style.css"
                  rel="stylesheet" media="screen">
        @else
            <link  href="{{vh_theme_assets_url("ProductTheme", "css/build.css")}}"
                   rel="stylesheet" media="screen">
            <link  href="{{vh_theme_assets_url("ProductTheme", "css/style.css")}}"
                rel="stylesheet" media="screen">
        @endif
        -->
