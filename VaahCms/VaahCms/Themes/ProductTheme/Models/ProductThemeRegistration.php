<?php namespace VaahCms\Themes\ProductTheme\Models;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Crypt;
use Illuminate\Support\Str;
use VaahCms\Themes\ProductTheme\Notifications\ActivationLinkNotification;
use WebReinvent\VaahCms\Entities\Registration;
use WebReinvent\VaahCms\Entities\User;

class ProductThemeRegistration extends Registration
{
	...
	public static function activateRegistration($request)
    {
        ...
        // Create User
        $user = ProductThemeUser::createUser($user_request);
        ...
        $response['status'] = 'success';
        $response['data']['redirect_url'] = route('vh.frontend.producttheme.signin');
